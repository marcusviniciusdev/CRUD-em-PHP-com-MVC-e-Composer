...
class Router
{
    private $controller = 'Site'; //armazena o nome da classe principal descrita na url
    private $method = 'home'; //armazena o nome da página que você quer acessar principal descrita na url
    private $param = []; //armazena um parametro passado na url 
